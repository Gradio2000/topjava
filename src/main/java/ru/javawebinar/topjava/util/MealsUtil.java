...
public class MealsUtil {
    ...
    public static final List<Meal> meals = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 31, 11, 0), "Завтрак", 410, 2)
    ...
    public static List<MealTo> getFilteredByDateAndTime(Collection<Meal> meals, int caloriesPerDay, LocalDate startDate, LocalDate endDate, LocalTime startTime, LocalTime endTime){
        return filterByPredicate(meals, caloriesPerDay, meal -> DateTimeUtil.isBetweenAll(meal.getDate(), startDate, endDate, meal.getTime(), startTime, endTime));
    }
